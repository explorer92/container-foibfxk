...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-foibfxk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-foibfxk.containers.anotherwebservice.com/
...
```
git clone git@github.com:explorer92/container-foibfxk.git
cd container-foibfxk
```
...
```
docker attach container-foibfxk
```
